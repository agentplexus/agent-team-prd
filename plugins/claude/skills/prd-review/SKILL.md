---
name: prd-review
description: Reviews existing PRDs against quality rubric, identifies gaps, and provides prioritized improvement recommendations. Activated when reviewing, scoring, or improving PRDs.
triggers: [review prd, score prd, prd review, improve prd, prd score, quality check]
