...
tasks:
  - id: identify-competitors
    ...
    type: manual
    required: true
    expected_output: Competitor list with analysis

  - id: analyze-alternatives
    description: Document all alternatives including non-software
    type: manual
    required: true
    expected_output: Alternatives analyzed

  - id: identify-differentiation
    description: Identify differentiation opportunities
    type: manual
    required: true
    expected_output: Differentiation strategy

  - id: assess-market-expectations
    description: Document market expectations and pricing
    type: manual
    required: false
    expected_output: Market expectations documented

  - id: identify-market-risks
    description: Flag market-related risks
    type: manual
    required: true
    expected_output: Market risks documented
---
