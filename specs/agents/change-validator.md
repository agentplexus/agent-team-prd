...
tasks:
  - id: verify-fixes
    description: Verify issues were actually resolved
    type: manual
    required: true
    expected_output: Fix verification complete

  - id: check-consistency
    description: Check for new inconsistencies
    type: manual
    required: true
    expected_output: Consistency check complete

  - id: detect-regressions
    description: Detect regressions from changes
    type: manual
    required: true
    expected_output: Regression check complete

  - id: validate-alignment
    description: Ensure metrics, requirements, and problem still align
    type: manual
    required: true
    expected_output: Alignment validated
---
