...
tasks:
  - id: define-functional-requirements
    description: Define functional requirements with acceptance criteria
    type: manual
    required: true
    expected_output: Functional requirements documented

  - id: define-nfrs
    description: Define non-functional requirements
    type: manual
    required: true
    expected_output: NFRs documented

  - id: write-user-stories
    description: Write user stories for key requirements
    type: manual
    required: false
    expected_output: User stories written

  - id: trace-requirements
    description: Trace requirements to problems and goals
    type: manual
    required: true
    expected_output: Traceability links documented

  - id: validate-testability
    description: Ensure all requirements are testable
    type: manual
    required: true
    expected_output: All requirements have acceptance criteria
---
