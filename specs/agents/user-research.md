...
tasks:
  - id: define-personas
    description: Create realistic user personas grounded in behavior
    type: manual
    required: true
    expected_output: Primary and secondary personas defined

  - id: map-pain-points
    description: Document user pain points with evidence
    type: manual
    required: true
    expected_output: Pain points mapped to personas

  - id: identify-behaviors
    description: Document observable user behaviors
    type: manual
    required: true
    expected_output: Behavioral patterns documented

  - id: flag-assumptions
    description: Distinguish facts from assumptions about users
    type: manual
    required: true
    expected_output: Assumptions explicitly flagged

  - id: identify-research-gaps
    description: Identify what we don't know about users
    type: manual
    required: true
    expected_output: Research gaps documented
---
