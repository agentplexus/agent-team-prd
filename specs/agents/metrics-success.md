...
tasks:
  - id: define-north-star
    description: Define the North Star metric
    type: manual
    required: true
    expected_output: North Star metric defined

  - id: define-success-metrics
    description: Define supporting success metrics
    type: manual
    required: true
    expected_output: Success metrics defined

  - id: define-guardrails
    description: Define guardrail metrics
    type: manual
    required: true
    expected_output: Guardrail metrics defined

  - id: assess-instrumentation
    description: Identify instrumentation gaps
    type: manual
    required: true
    expected_output: Instrumentation gaps documented

  - id: validate-measurability
    description: Ensure all metrics are measurable
    type: manual
    required: true
    expected_output: All metrics validated as measurable
---
