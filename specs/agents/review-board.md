...
tasks:
  - id: product-review
    description: Review PRD from product strategy perspective
    type: manual
    required: true
    expected_output: Product review complete with recommendation

  - id: engineering-review
    description: Review PRD from engineering feasibility perspective
    type: manual
    required: true
    expected_output: Engineering review complete with recommendation

  - id: design-review
    description: Review PRD from UX perspective
    type: manual
    required: true
    expected_output: Design review complete with recommendation

  - id: data-review
    description: Review PRD from measurement perspective
    type: manual
    required: true
    expected_output: Data review complete with recommendation

  - id: business-review
    description: Review PRD from business impact perspective
    type: manual
    required: true
    expected_output: Business review complete with recommendation

  - id: aggregate-reviews
    description: Aggregate reviewer recommendations into final decision
    type: manual
    required: true
    expected_output: Final recommendation with consensus status
---
