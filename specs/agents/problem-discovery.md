...
tasks:
  - id: define-primary-problem
    description: Identify and articulate the core user problem
    type: manual
    required: true
    expected_output: Clear problem statement with evidence

  - id: identify-root-causes
    description: Distinguish root causes from symptoms
    type: manual
    required: true
    expected_output: Root causes documented

  - id: segment-users
    description: Identify which users experience the problem
    type: manual
    required: true
    expected_output: User segments defined

  - id: articulate-jtbd
    description: Define Jobs-To-Be-Done for affected users
    type: manual
    required: true
    expected_output: JTBD statements

  - id: identify-evidence-gaps
    description: Flag assumptions and missing evidence
    type: manual
    required: true
    expected_output: Evidence gaps documented
---
