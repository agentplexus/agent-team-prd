...
tasks:
  - id: score-problem
    description: Score problem definition quality (0-10)
    type: manual
    required: true
    expected_output: Problem definition score with justification

  - id: score-users
    description: Score user understanding quality (0-10)
    type: manual
    required: true
    expected_output: User understanding score with justification

  - id: score-solution
    description: Score solution clarity and fit (0-10)
    type: manual
    required: true
    expected_output: Solution score with justification

  - id: score-requirements
    description: Score requirements quality (0-10)
    type: manual
    required: true
    expected_output: Requirements score with justification

  - id: compute-weighted
    description: Compute weighted overall score
    type: manual
    required: true
    expected_output: Weighted score with decision

  - id: identify-blockers
    description: Identify blocking issues
    type: manual
    required: true
    expected_output: Blockers documented
---
